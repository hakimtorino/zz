...
def swag():
	amazon = random.choice(["Fire Phone"])
	ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(111111111,777777777))+";[FBAN/FB4A;FBAV/252.0.0.20.120;FBBV/217842181;FBDM/{density=3.25,width=1080,height=1920};FBLC/en_US;FBCR/HOME;FBMF/Amazon;FBBD/amazon;FBPN/com.facebook.katana;FBDV/Fire Phone;FBSV/6.4.2;FBCA/arm64-v8a:;]"
	return ua
